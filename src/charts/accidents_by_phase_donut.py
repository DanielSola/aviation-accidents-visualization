...
def accidents_by_phase(data):
    ...
    st.markdown(
        """
        This donut chart provides a breakdown of accidents by the phase of flight, showing data for a total of 61,027 incidents. The largest proportion of accidents occurs during the landing phase (25.3%), followed by takeoff (20.5%). The data highlights that critical moments like landing and takeoff are the most accident-prone phases of flight.
        """
    )